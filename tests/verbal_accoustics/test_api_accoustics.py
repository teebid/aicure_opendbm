...
class AccousticTest:
    def test_get_audio_intensity(
        ...
        res_mp4 = processing_verbal_accoustics_mp4.get_audio_intensity()
        res_wav = processing_verbal_accoustics_wav.get_audio_intensity()
    ...
    def test_get_pitch_frequency(
        ...
        res_mp4 = processing_verbal_accoustics_mp4.get_pitch_frequency()
        res_wav = processing_verbal_accoustics_wav.get_pitch_frequency()
    ...
    def test_get_formant_frequency(
        ...
        res_mp4 = processing_verbal_accoustics_mp4.get_formant_frequency()
        res_wav = processing_verbal_accoustics_wav.get_formant_frequency()
    ...
    def test_get_harmonic_noise(
        ...
        res_mp4 = processing_verbal_accoustics_mp4.get_harmonic_noise()
        res_wav = processing_verbal_accoustics_wav.get_harmonic_noise()
    ...
    def test_get_glottal_noise(
        ...
        res_mp4 = processing_verbal_accoustics_mp4.get_glottal_noise()
        res_wav = processing_verbal_accoustics_wav.get_glottal_noise()
    ...
    def test_get_jitter(
        ...
        res_mp4 = processing_verbal_accoustics_mp4.get_jitter()
        res_wav = processing_verbal_accoustics_wav.get_jitter()
    ...
    def test_get_shimmer(
        ...
        res_mp4 = processing_verbal_accoustics_mp4.get_shimmer()
        res_wav = processing_verbal_accoustics_wav.get_shimmer()
    ...
    def test_get_pause_characteristics(
        ...
        res_mp4 = processing_verbal_accoustics_mp4.get_pause_characteristics()
        res_wav = processing_verbal_accoustics_wav.get_pause_characteristics()
    ...
    def test_get_voice_prevalence(
        ...
        res_mp4 = processing_verbal_accoustics_mp4.get_voice_prevalence()
        res_wav = processing_verbal_accoustics_wav.get_voice_prevalence()
